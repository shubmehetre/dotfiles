...
require('lazy').setup({
  ...
  { -- NOTE: Fuzzy Finder Section(files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sc', ':Telescope colorscheme<CR>', { desc = '[S]earch [C]olorscheme', silent = true })
      ...
      end, { desc = '[S]earch [/] in All Open Files' })
  ...
  -- Status line
  { 'nvim-lualine/lualine.nvim', event = 'VimEnter', opts = { icons_enabled = true } },
